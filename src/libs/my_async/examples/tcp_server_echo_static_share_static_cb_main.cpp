...
using Session_CB = TCP::Session_Static_Share_Static_Callback<UseSSL, std::string>;
...
template<bool UseSSL>
void on_message(std::shared_ptr<Session_CB<UseSSL>>, std::string data){
	std::cout << "data: " << data << "\n";
	Session_CB<UseSSL>::write_all(data);
}
