#ifndef SERIAL_ASYNC_CALLBACK_IMPL_HPP__
#define SERIAL_ASYNC_CALLBACK_IMPL_HPP__
...
void
Serial_Callback<InContainer, OutContainer, ReadBufferSize>
::on_open() noexcept
{
...
#endif /* SERIAL_ASYNC_CALLBACK_IMPL_HPP__ */
